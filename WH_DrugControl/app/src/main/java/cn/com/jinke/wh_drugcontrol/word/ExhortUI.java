...
@Route(path = RouteUtils.R_WORD_EXHORT_UI)
public class ExhortUI extends BaseWordUI {
        ...
        case JUDGE_CREATETIME: // 判断文档创建时间
            ...
            if (msg.arg1 == SUCCESS) {
                ...
                showAlterMessageDialog(message, alterType, mDocument.getId(),
                        mPersion.getId(), object.getId(), DOC_TYPE_EXHORT);
            }
            break;
        default:
            break;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ui_word_exhort);
    ...
    private void click(View view) {
        ...
        case R.id.alter_layout:
            ...
            TaskManager.getInstance().judgeCreateTime(object.getId(), DOC_TYPE_EXHORT);
            break;
        default: // no code
            break;
        }
    ...
    private void updateUi(Exhort object) {
        ...
        mSzlktsEt.setText(String.format(Locale.CHINESE, "%s", object.getLeaveDays())+"天");
        mSzlkcsEt.setText(String.format(Locale.CHINESE, "%s", PersionUtil.getTimesCount(object.getLeaveCounts())));
        ...
        mTbjjcsEt.setText(String.format(Locale.CHINESE, "%s", PersionUtil.getTimesCount(object.getDenyCounts())));
