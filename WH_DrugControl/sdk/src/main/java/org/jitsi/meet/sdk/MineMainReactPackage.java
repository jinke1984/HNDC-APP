...
/**
 * Created by pjee on 18-1-25.
 */

public class MineMainReactPackage extends LazyReactPackage {
    private MainPackageConfig mConfig;

    public MineMainReactPackage() {
    }

    /**
     * Create a new package with configuration
     */
    public MineMainReactPackage(MainPackageConfig config) {
        mConfig = config;
    }
